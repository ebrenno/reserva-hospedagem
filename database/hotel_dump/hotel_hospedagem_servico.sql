...
CREATE TABLE `hospedagem_servico` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKk9fwl0aqjwfvlokc1gg6axpgc` (`hospedagem_id`),
  KEY `FKrha4kqo7ptiq19btt1bg4d4st` (`servico_id`),
  CONSTRAINT `FKk9fwl0aqjwfvlokc1gg6axpgc` FOREIGN KEY (`hospedagem_id`) REFERENCES `hospedagem` (`id`),
  CONSTRAINT `FKrha4kqo7ptiq19btt1bg4d4st` FOREIGN KEY (`servico_id`) REFERENCES `servico` (`id`)
...
-- Dump completed on 2020-02-13 20:31:48
